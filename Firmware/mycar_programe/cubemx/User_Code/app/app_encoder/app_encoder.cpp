...
encoder motor1Encoder(6480, motor1Encoder_get_count_link);
encoder motor2Encoder(6480, motor2Encoder_get_count_link);

/* motor1Encode 读取函数 */
float motor1Encoder_get_count_link(void)
{
	return motor1.true_angle;
}

/* motor2Encode 读取函数 */
float motor2Encoder_get_count_link(void)
{
	return motor2.true_angle;
}
